...
namespace TrainingPractice_01
{
	...
	internal class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				// проверка на корректность координат; может ли слон бить фигуру
				try
				{
		...
		// Проверка, может ли слон побить фигуру за один ход, а также проверка нахождения фигуры на одной диагонали со слоном
